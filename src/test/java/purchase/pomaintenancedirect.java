...
//	public static ExtentTest test;
	// Please do automation for PO entry (Direct i.e. without indent) with 2 items
	// and 1st item with 3 delivery schedule and 2nd item with 1 delivery schedule).
	...
	public void POD001() throws Exception {
		...
		Library.Comboclick(element.getPOBASIS(), Excel.getStringdata("testdata", 1, 5), "PO BAsis");
		Thread.sleep(5000);
		Library.Explicitlywait(element.getPODATE());

		calendar.daypicker(element.getPODATE(), Excel.getStringnumberdata("testdata", 1, 2),
				Excel.getStringdata("testdata", 1, 3), Excel.getStringnumberdata("testdata", 1, 4));
		Thread.sleep(1500);
		...
		Thread.sleep(5000);
		vendorsearch.click();
		vendorsearch.sendKeys(Excel.getStringnumberdata("testdata", 1, 6));
...
//		
	...
	public void POD003() throws Exception {
		...
		Library.custom_click(element.getPOaddnewbutton(), "Add New Btn");
		Thread.sleep(5000);
		Library.Comboclick(element.getPOBASIS(), Excel.getStringdata("POD001", 1, 5), "PO BAsis");
		Thread.sleep(5000);

		WebElement calendorinput = driver.findElement(By.xpath("//input[contains(@id,'inputjqxWidget')]"));

		calendar.daypicker(element.getPODATE(), Excel.getStringdata("POD001", 1, 2),
				Excel.getStringdata("POD001", 1, 3), Excel.getStringdata("POD001", 1, 4));
		Thread.sleep(1500);
		Library.dClick(element.getPOINFONEXTBTN(), "PO Next Button");
		...
		Thread.sleep(5000);
		vendorsearch.click();
		vendorsearch.sendKeys(Excel.getStringdata("POD001", 1, 6));
		vendorsearch.sendKeys(Keys.ENTER);
//		 JavascriptExecutor js = (JavascriptExecutor)driver;
		Thread.sleep(5000);
		Library.Scrolldown(0, 30);
...
//			
		Thread.sleep(2000);
//			Library.Explicitlywait(element.getBuyer());
		String buyer = Excel.getStringdata("POD001", 1, 7);
		...
		Library.dClick(element.getVendorInfoNextBtn(), "VendorInfoNextBtn()");
		Thread.sleep(2000);
		String RateStructure = Excel.getStringdata("POD001", 1, 8);
		...
		FirstItembtn.click();
		// Library.searchwindowpopup(FirstItembtn,config.getconfigdata("ITEMCODE"));
		String itemcode = Excel.getStringdata("POD001", 1, 9);
...
//			Itemcode.sendKeys(Keys.ENTER);
		...
		Thread.sleep(12000);
		JQXGRID.JQXDropdown(warehousecode, Excel.getStringdata("POD001", 1, 10));
		Thread.sleep(6000);
