...
public class AutoDeAllocationpom {
	

	@FindBy(how=How.XPATH,using="//span[text()='Planning']")
	private WebElement PLANNINGMODULE;
	@FindBy(how=How.XPATH,using="//a[text()='Auto DeAllocation']")
	private WebElement AutoDeAllocation;
  ...
  //div[contains(@id,'columntablejqxWidget')]/div[1]
	...
	public WebElement getAutoDeAllocation() {
		return AutoDeAllocation;
	}
